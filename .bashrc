...
export PATH=$PATH:$HOME/INSTALL/ghc/bin
export PATH=$PATH:$HOME/INSTALL/node-v12.19.0-linux-x64/bin
export PATH=$PATH:$HOME/INSTALL/anki-2.1.35-linux-amd64/bin
setxkbmap -option caps:swapescape
setxkbmap -option compose:ralt


alias monitors='xrandr --output eDP-1 --auto --output DP-2 --mode 3840x1600
--above eDP-1'
...
alias grhr='git reset --hard && git submodule foreach --recursive git reset
--hard'
